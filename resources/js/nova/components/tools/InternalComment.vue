...
export default {
  ...
  computed: {
    commentString: () => _.find(this.comment.fields, { attribute: 'comment' }).value,
    hasCommenter: () => Boolean(this.commenter),
    commenter: () => _.find(this.comment.fields, { attribute: 'commenter' }).value,
    commenterUrl() {
